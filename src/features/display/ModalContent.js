...
import PackageSizeOptions from '../bridgecomponents/PackageSizeOptions';
...
const ModalContent = ({
    ...
    const [showPackageSizeOptions, setShowPackageSizeOptions] = useState(true);
    const [selectedPackageSize, setSelectedPackageSize] = useState('');
    const [selectedQuantity, setSelectedQuantity] = useState(1); // Initialize selectedQuantity to 1
    ...
    const handleAddToCart = () => {
        ...
        console.log("Selected Base Curve:", selectedBaseCurve);
    };
    ...
    // const prices = ALCONPRICES.map(item => item.MSRP);
                ...
                <Modal isOpen={secondModalOpen} toggle={toggleSecondModal} className="second-modal">
                    ...
                    <ModalBody>
                        ...
                        <div className="dropdown-wrapper">
                            ...
                            {showPackageSizeOptions && (
                                <div id='box-option-dropdown' className='dropdown-item'>
                                    <label>Box Options:</label>
                                    <PackageSizeOptions
                                        name={name}
                                        // prices={prices} // Pass the prices array as a prop
                                        onSelectPackageSize={handlePackageSizeChange}
                                        showPackageSizeOptions={showPackageSizeOptions}
                                        setShowPackageSizeOptions={setShowPackageSizeOptions}
                                        MSRP={MSRP}
                                        boxID={boxID}
                                    />
                                    {/* <p id='box-option-text'>*for one eye</p> */}
                                </div>
                            )}
